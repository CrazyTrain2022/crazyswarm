...
if __name__ == "__main__":
    ...
    for i in range(TRIALS):
        ...
        cf4.goTo(np.array([2.17,0,1.55]), 0, 2.0)
        ...
        timeHelper.sleep(0.5)
        cf3.goTo(np.array([0.25,0.0,1.2]), 0, 2.0)
        timeHelper.sleep(0.5)
        cf3.goTo(np.array([0.15,0.0,0.9]), 0, 2.0)
        timeHelper.sleep(0.5)
        cf3.goTo(np.array([0.0,0.0,0.75]), 0, 2.0)

        cf4.goTo(np.array([1.67,0,1.55]), 0, 2.0)    
        ...
        timeHelper.sleep(2.0)
        cf4.goTo(np.array([1,0,0.8]), 0, 2.0)
        timeHelper.sleep(2.0)
        cf4.goTo(np.array([1.535,0,0.5]), 0, 2.0)
        timeHelper.sleep(0.50)
        cf4.goTo(np.array([1.635,0,0.5]), 0, 2.0)
        timeHelper.sleep(0.50)
        cf4.goTo(np.array([2.17,0,0.8]), 0, 2.0)
        timeHelper.sleep(2.0)
        cf4.goTo(np.array([2.17,0,1.55]), 0, 2.0)      
